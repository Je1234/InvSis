        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-primary">
                    ...
                    <h4 class="card-title">Lista de bodegas eliminados</h4>
                    <div class="form-check form-check-inline float-right">
                        <div class="btn-toolbar" role="group">
                           @if(!$ubicacionB->isEmpty())
                            <button type="button" data-toggle="modal" data-target="#RecuperarAllUb" class="btn btn-black col-xs-1"><i class="material-icons">restore_from_trash</i>Recuperar todo</button>
                            @endif
                            <a type="button" href="{{route('ubicacion.index')}}" class="btn btn-black"><i class="material-icons">reply</i>Regresar a ubicaciones</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="card card-collapse">
                            <div class="card-header card-header-primary" role="tab" id="heading{{$i}}">
                                <h5 class="mb-0">
                                    ...
                                    <button type="button" class="btn btn-black float-right btn-sm" data-id_ubicacion="{{$ub->id_ubicacion}}" data-toggle="modal" data-target="#RecuperarUbicacion" rel="tooltip"><i class="material-icons">reply</i></button>
                                </h5>
                            </div>
...
<!--Modal recuperar bodega-->
<div class="modal fade" id="RecuperarUbicacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header header-primary">
                <h5 class="modal-title" id="exampleModalLabel">Recuperar bodega</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <!-- Formulario -->
                <form class="form-submit-limit" action="{{route('Rubicacion')}}" method="POST">
                    @csrf
                    @method('GET')
...
<div class="modal fade" id="RecuperarAllUb" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header header-primary">
            ...
            <div class="modal-body">
                <!-- Formulario -->
                <form class="form-submit-limit" action="{{route('RAubicacion')}}" method="POST">
                    @csrf
                    @method('GET')
                    <input type="hidden" id="id_ubicacion" name="id_ubicacion">
